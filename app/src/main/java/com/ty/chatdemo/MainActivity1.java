...
public class MainActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.register).setOnClickListener(v ->    ChatSdk.getClient().register(Api.source));
        findViewById(R.id.connect).setOnClickListener(v -> mainViewModel.getSig());
        ...
        mainViewModel.signLiveData.observe(this,new NetObserver<BaseEntity<String>>(){
            ...
            protected void onSuccess(BaseEntity<String> baseEntity) {
                ChatSdk.url = StringUtils.getFormatString(ResUtils.getString(R.string.app_url),baseEntity.getData());
