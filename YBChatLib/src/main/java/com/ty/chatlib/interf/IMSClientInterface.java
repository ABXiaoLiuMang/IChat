...
public interface IMSClientInterface {
     ...
     * @param msg
     */
    void sendMsg(GeneratedMessageV3 msg);
     ...
     */
    void sendMsg(GeneratedMessageV3 msg, boolean isJoinTimeoutManager);
